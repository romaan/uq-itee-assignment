...
namespace Practical2Task2.ValidityAreaCodeWebRef {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="AreaCodeValiditySoap", Namespace="http://tempuri.org/")]
    public partial class AreaCodeValidity : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public AreaCodeValidity() {
            this.Url = global::Practical2Task2.Properties.Settings.Default.Practical2Task2_ValidityAreaCodeWebRef_AreaCodeValidity;
        ...
        /// <remarks/>
        public void IsValidAsync(string state, string code) {
            this.IsValidAsync(state, code, null);
        }
        
        /// <remarks/>
        public void IsValidAsync(string state, string code, object userState) {
            ...
            this.InvokeAsync("IsValid", new object[] {
                        state,
                        code}, this.IsValidOperationCompleted, userState);
        }
