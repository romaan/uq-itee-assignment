...
namespace prac1_2WebApplication.AreaCodeValidatorRef {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="AreaCodeValidatorWebServiceSoap", Namespace="http://tempuri.org/")]
    public partial class AreaCodeValidatorWebService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public AreaCodeValidatorWebService() {
            this.Url = global::prac1_2WebApplication.Properties.Settings.Default.prac1_2WebApplication_AreaCodeValidatorRef_AreaCodeValidatorWebService;
        ...
        /// <remarks/>
        public void IsValidAsync(string ac, string st) {
            this.IsValidAsync(ac, st, null);
        }
        
        /// <remarks/>
        public void IsValidAsync(string ac, string st, object userState) {
            ...
            this.InvokeAsync("IsValid", new object[] {
                        ac,
                        st}, this.IsValidOperationCompleted, userState);
        }
