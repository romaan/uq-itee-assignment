...
namespace prac1_2WebApplication.AddSearchRef {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="AddSearchWebServiceSoap", Namespace="http://tempuri.org/")]
    public partial class AddSearchWebService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback SearchByPhoneOperationCompleted;
        
        private bool useDefaultCredentialsSetExplicitly;
        
        /// <remarks/>
        public AddSearchWebService() {
            this.Url = global::prac1_2WebApplication.Properties.Settings.Default.prac1_2WebApplication_AddSearchRef_AddSearchWebService;
        ...
        /// <remarks/>
        public event SearchByPhoneCompletedEventHandler SearchByPhoneCompleted;
        ...
        /// <remarks/>
        public void AddContactAsync(string fn, string ln, string ac, string phn, string addr, string st, string em, string dob) {
            this.AddContactAsync(fn, ln, ac, phn, addr, st, em, dob, null);
        }
        
        /// <remarks/>
        public void AddContactAsync(string fn, string ln, string ac, string phn, string addr, string st, string em, string dob, object userState) {
            ...
            this.InvokeAsync("AddContact", new object[] {
                        ...
                        st,
                        em,
                        dob}, this.AddContactOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        public void SearchByNameAsync(string ln) {
            this.SearchByNameAsync(ln, null);
        }
        
        /// <remarks/>
        public void SearchByNameAsync(string ln, object userState) {
            ...
            this.InvokeAsync("SearchByName", new object[] {
                        ln}, this.SearchByNameOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/SearchByPhone", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public string SearchByPhone(string phn) {
            object[] results = this.Invoke("SearchByPhone", new object[] {
                        phn});
            return ((string)(results[0]));
        }
        
        /// <remarks/>
        public void SearchByPhoneAsync(string phn) {
            this.SearchByPhoneAsync(phn, null);
        }
        
        /// <remarks/>
        public void SearchByPhoneAsync(string phn, object userState) {
            if ((this.SearchByPhoneOperationCompleted == null)) {
                this.SearchByPhoneOperationCompleted = new System.Threading.SendOrPostCallback(this.OnSearchByPhoneOperationCompleted);
            }
            this.InvokeAsync("SearchByPhone", new object[] {
                        phn}, this.SearchByPhoneOperationCompleted, userState);
        }
        
        private void OnSearchByPhoneOperationCompleted(object arg) {
            if ((this.SearchByPhoneCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.SearchByPhoneCompleted(this, new SearchByPhoneCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.17379")]
    public delegate void SearchByPhoneCompletedEventHandler(object sender, SearchByPhoneCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.17379")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class SearchByPhoneCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal SearchByPhoneCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
