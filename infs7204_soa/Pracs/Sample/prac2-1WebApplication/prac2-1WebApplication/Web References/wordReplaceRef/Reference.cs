...
namespace prac2_1WebApplication.wordReplaceRef {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="wordReplaceSoap", Namespace="http://tempuri.org/")]
    public partial class wordReplace : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public wordReplace() {
            this.Url = global::prac2_1WebApplication.Properties.Settings.Default.prac2_1WebApplication_wordReplaceRef_wordReplace;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/replace", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        ...
        /// <remarks/>
        public void replaceAsync(string oldWord, string newWord, string text) {
            this.replaceAsync(oldWord, newWord, text, null);
        }
        
        /// <remarks/>
        public void replaceAsync(string oldWord, string newWord, string text, object userState) {
            ...
            this.InvokeAsync("replace", new object[] {
                        oldWord,
                        newWord,
                        text}, this.replaceOperationCompleted, userState);
        }
