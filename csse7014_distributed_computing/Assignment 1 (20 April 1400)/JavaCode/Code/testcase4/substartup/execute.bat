...
REM "User Three Location Sensor"
start cmd.exe /C userthreelocation.bat
ping 1.1.1.1 -n 1 -w 2000 > nul

REM "User three BP Heart"
start cmd.exe /C userthreeBPHeart.bat
ping 1.1.1.1 -n 1 -w 2000 > nul

REM "Starting User Interface"
start cmd.exe /C userthreeUI.bat
ping 1.1.1.1 -n 1 -w 2000 > nul