 ...
 * Uses RMI to request current temperature and BP heart rate
 ******************************************/
...
private String userName;
	...
	private void callRemoteMethod(char ch, UIHomemanagerPrx aUIHomeManager) {
		switch (ch) {
		case '1'://Remote metod invocation 
				System.out.println("Current Temperature is:"+aUIHomeManager.getTemperature()); 
					break;
