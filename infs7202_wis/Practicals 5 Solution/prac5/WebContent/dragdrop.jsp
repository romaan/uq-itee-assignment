...
<div id="all" ondrop="drop(event)" ondragover="allowDrop(event)">
	...
	<img src="images/2.jpg" draggable="true" ondragstart="drag(event)" id="drag2" />
	<img src="images/3.jpg" draggable="true" ondragstart="drag(event)" id="drag3" />
	<img src="images/4.jpg" draggable="true" ondragstart="drag(event)" id="drag4" />
	<img src="images/5.jpg" draggable="true" ondragstart="drag(event)" id="drag5" />
	<img src="images/6.jpg" draggable="true" ondragstart="drag(event)" id="drag6" />
	<img src="images/7.jpg" draggable="true" ondragstart="drag(event)" id="drag7" />
</div>
