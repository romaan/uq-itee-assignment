...
<body>
<h1 align="center">Search Album</h1>
<hr/>
...
<div style="text-align: center;">Search<input type="text" id="searchtag" name="tag"/><input type="button" name="search" value="Search" onClick="searchalbum();"/>
<br/><br/><hr/>
